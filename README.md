...
>
> - **Text-to-speech readout of agent replies in the mobile app** — a per-message "Read aloud" button on completed agent messages, plus a Settings → Thread behavior → "Read Replies Aloud" toggle that speaks new replies as they complete (via `expo-speech`, using the device TTS engine — no Google Play services required).
