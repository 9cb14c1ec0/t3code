...
> - **Forgejo and Gitea as a source control provider** — clone, detect remotes, and create or check out pull requests on Codeberg, gitea.com, and self-hosted instances via the `fj` CLI. The dedicated Pull requests inbox is still GitHub / GitLab / Bitbucket / Azure DevOps only.
