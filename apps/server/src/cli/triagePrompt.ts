...
Work from evidence, not assumption. In rough order of value:
...
- The SQLite database. Read it freely; NEVER write to it.
...
- Database (SQLite, read only, never write): ${input.paths.dbPath}
