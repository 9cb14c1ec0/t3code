...
GitLab calls these merge requests. Forgejo and Gitea pull requests always open in the system
browser; the dedicated inbox and in-app review panel do not support them yet. Use the Git toolbar
or a pull request link to open the host's own page.
